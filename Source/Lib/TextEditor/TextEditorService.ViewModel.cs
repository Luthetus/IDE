...
public partial class TextEditorService
{
    ...
    #region READ_METHODS
    public TextEditorViewModel? ViewModel_GetOrDefault(int viewModelKey)
    {
        return TextEditorState.ViewModelGetOrDefault(viewModelKey);
    }

    public Dictionary<int, TextEditorViewModel> ViewModel_GetViewModels()
    {
        return TextEditorState.ViewModelGetViewModels();
    }

    public TextEditorModel? ViewModel_GetModelOrDefault(int viewModelKey)
    {
    ...
    public string? ViewModel_GetAllText(int viewModelKey)
    {
        ...
        TextEditorViewModel viewModel)
    {
        ...
        catch (ClairTextEditorException exception)
        {
        ...
        TextEditorComponentData componentData)
    {
        ...
        while (true)
        {
            ...
            var lineInformation = new Clair.TextEditor.RazorLib.Lines.Models.LineInformation(
                lineIndex,
    ...
    public void ViewModel_Dispose(TextEditorEditContext editContext, int viewModelKey)
    {
