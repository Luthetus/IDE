...
const clairCommonDebounce = (callback, wait) => {
  let timeoutId = null;
  return (...args) => {
...
const clairCommonOnWindowSizeChanged = clairCommonDebounce(() => {
    var localBrowserResizeInteropDotNetObjectReference = clairCommon.browserResizeInteropDotNetObjectReference;
    var localRootHtmlElementId = clairCommon.rootHtmlElementId;
	...
	localBrowserResizeInteropDotNetObjectReference
		.invokeMethodAsync("OnBrowserResize", clairCommon.measureAppDimensionState(localRootHtmlElementId))
		.then(data => data);
}, 300);
...
window.clairCommon = {
    ...
    subscribeWindowSizeChanged: function (browserResizeInteropDotNetObjectReference, rootHtmlElementId) {
    	...
    	clairCommon.browserResizeInteropDotNetObjectReference = browserResizeInteropDotNetObjectReference;
    	clairCommon.rootHtmlElementId = rootHtmlElementId;
        window.addEventListener("resize", clairCommonOnWindowSizeChanged);
        ...
        return clairCommon.measureAppDimensionState(localRootHtmlElementId);
    },
    disposeWindowSizeChanged: function () {
    	clairCommon.browserResizeInteropDotNetObjectReference = null;
        window.removeEventListener("resize", clairCommonOnWindowSizeChanged);
    },
