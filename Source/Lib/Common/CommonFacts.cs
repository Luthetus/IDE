...
public static class CommonFacts
{
    ...
    public static readonly ThemeRecord DarkTheme = new ThemeRecord(
        Key: 3,
        "Clair IDE Dark Theme",
        "ci_dark-theme",
        ThemeContrastKind.Default,
        ThemeColorKind.Dark,
        IncludeScopeApp: false,
        IncludeScopeTextEditor: true);
    /* End ClairTextEditorCustomThemeFacts */
    
    /* Start ContextFacts */
    /// <summary>
    /// Used when repositioning a dropdown so that it appears on screen.
    /// </summary>
    public static string RootHtmlElementId { get; set; } = "ci_global";
    /* End ContextFacts */
    ...
    public static FileTemplateResult CreateFileTemplate(FileTemplateParameter templateParameter)
    {
        switch (templateParameter.ExtensionNoPeriod)
        {
            /// <summary>
            /// Template should be:
            /// -------------------
            /// namespace Clair.Ide.ClassLib.FileTemplates;
            ///
            /// public class Asdf
            /// {
            ///     
            ...
            /// 
            /// </summary>
            case CommonFacts.C_SHARP_CLASS:
            {
                ...
                var emptyFileAbsolutePath = new AbsolutePath(
                    ...
                    false,
                    templateParameter.FileSystemProvider,
...
".ReplaceLineEndings();
            ...
            /// using Microsoft.AspNetCore.Components;
            /// 
            /// namespace Clair.Ide.RazorLib.Menu;
            /// 
            ...
            ///
            /// </summary>
            case CommonFacts.RAZOR_CODEBEHIND:
            {
                string GetContent(string fileNameNoExtension, string namespaceString)
                {
...
".ReplaceLineEndings();
            ...
            default:
            {
                ...
                return new FileTemplateResult(emptyFileAbsolutePath, templateParameter.ParentDirectoryNamespace, string.Empty);
            }
        }
    }

    public static List<FileTemplate>? GetRelatedFileTemplates(string extensionNoPeriod)
    {
        switch (extensionNoPeriod)
        {
            case CommonFacts.C_SHARP_CLASS:
                return null;
            case CommonFacts.RAZOR_CODEBEHIND:
    ...
    public static readonly FileTemplate CSharpClass = new(
        "C# Class",
        FileTemplateKind.CSharp,
        CommonFacts.C_SHARP_CLASS,
        true);

    public static readonly FileTemplate RazorCodebehind = new(
        "Razor codebehind",
        FileTemplateKind.Razor,
        CommonFacts.RAZOR_CODEBEHIND,
        true);

    public static readonly FileTemplate RazorMarkup = new(
        "Razor markup",
        FileTemplateKind.Razor,
        CommonFacts.RAZOR_MARKUP,
        true);
    ...
    public static Task RenderDropdownAsync(
        ...
        ClairCommonJavaScriptInteropApi clairCommonJavaScriptInteropApi,
        ...
        bool preventScroll)
    {
        return RenderDropdownAsync(
            commonService,
            clairCommonJavaScriptInteropApi,
            anchorHtmlElementId,
            dropdownOrientation,
            dropdownKey,
            menu,
            async () => 
            {
                try
                {
                    await clairCommonJavaScriptInteropApi
    ...
    public static string HtmlFacts_Button_ButtonPaddingHorizontalTotalInPixelsCssValue { get; } = $"2 * {HtmlFacts_Button_PADDING_IN_PIXELS.ToCssValue()}px";
    /* End HtmlFacts */
        ...
        List<string> ancestorDirectoryList)
    {
        ...
        if (moveUpDirectoryCount > 0)
        {
            ...
            else
            {
                ...
                return fileSystemProvider.DirectorySeparatorChar + relativePathString;
            }
        }
        else
        {
        ...
        StringBuilder formattedBuilder)
    {
        ...
        var startingPathAncestorDirectoryList = startingPath.GetAncestorDirectoryList(fileSystemProvider, tokenBuilder, formattedBuilder, AbsolutePathNameKind.NameWithExtension);
        var endingPathAncestorDirectoryList = endingPath.GetAncestorDirectoryList(fileSystemProvider, tokenBuilder, formattedBuilder, AbsolutePathNameKind.NameWithExtension);
        ...
        if (startingPathParentDirectory == endingPathParentDirectory)
        {
            ...
            pathBuilder.Append($".{fileSystemProvider.DirectorySeparatorChar}");
        ...
        else
        {
            ...
            {
                var startingPathAncestor = new AbsolutePath(
                ...
                var endingPathAncestor = new AbsolutePath(
