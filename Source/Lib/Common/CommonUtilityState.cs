...
public record struct AppOptionsState(CommonOptions Options)
{
    ...
    public AppOptionsState() : this(new(
    ...
    PanelGroup? DragEventArgs_PanelGroup)
{
    ...
    private static PanelGroup ConstructBottomGroup()
    {
        ...
        bottomPanelGroup.ElementDimensions.Height_Offset = new DimensionUnit(0, DimensionUnitKind.Pixels, DimensionOperatorKind.Subtract);
...
/// - The <see cref="Clair.Common.RazorLib.OutOfBoundsClicks.Displays.OutOfBoundsClickDisplay"/>
