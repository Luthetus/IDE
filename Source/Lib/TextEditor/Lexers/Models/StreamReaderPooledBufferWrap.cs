...
{
    public StreamReaderPooledBufferWrap()
    {
    }

    public StreamReaderPooledBufferWrap(StreamReaderPooledBuffer streamReader)
    {
    ...
    public StreamReaderPooledBuffer StreamReader { get; private set; }
