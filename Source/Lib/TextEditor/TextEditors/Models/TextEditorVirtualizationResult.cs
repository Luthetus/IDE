...
/// </summary>
public sealed class TextEditorVirtualizationResult
{
    ...
    public void CreateUi()
    {
        ...
        ComponentData.TextEditorViewModelSlimDisplay.TextEditorService.__StringBuilder.Append(ViewModel.PersistentState.GetGutterColumnHeightCssValue());
        ComponentData.TextEditorViewModelSlimDisplay.TextEditorService.__StringBuilder.Append("px;");
        ...
        GetPresentationLayer(ViewModel.PersistentState.FirstPresentationLayerKeysList);
        ...
        GetPresentationLayer(ViewModel.PersistentState.LastPresentationLayerKeysList);
    ...
    public void GetCursorAndCaretRowStyleCss()
    {
        ...
        ComponentData.TextEditorViewModelSlimDisplay.TextEditorService.__StringBuilder.Append((TextEditorFacts.Keymap_DefaultKeymap).GetCursorCssStyleString(
            Model,
            ViewModel,
    ...
    private void GetPresentationLayer(List<Key<TextEditorPresentationModel>> presentationLayerKeysList)
    {
        for (int presentationKeyIndex = 0; presentationKeyIndex < presentationLayerKeysList.Count; presentationKeyIndex++)
        {
            ...
            TextEditorPresentationModel? presentationLayer = null;
            foreach (var presentationModel in Model.PresentationModelList)
            {
                if (presentationModel.TextEditorPresentationKey == presentationKey)
                {
                    presentationLayer = presentationModel;
                    break;
                }
            }
        ...
        IReadOnlyList<TextEditorTextSpan> inTextSpanList)
    {
        ...
        if (Count > 0)
        {
            ...
            var lowerLine_lineEndLower = lowerLineIndexInclusive == 0
                ? new(0, 0, Clair.TextEditor.RazorLib.Lines.Models.LineEndKind.StartOfFile)
                : Model.LineEndList[lowerLineIndexInclusive - 1];
            var lowerLine_lineEndUpper = Model.LineEndList[lowerLineIndexInclusive];
            var lowerLine = new Clair.TextEditor.RazorLib.Lines.Models.LineInformation(
            ...
            var upperLine = new Clair.TextEditor.RazorLib.Lines.Models.LineInformation(
