...
public class TextEditorCommandDefaultFunctions
{
    ...
    public static async ValueTask RelatedFilesQuickPick(
        ...
        TextEditorModel modelModifier,
        TextEditorViewModel viewModel,
        ClairCommonJavaScriptInteropApi jsRuntimeCommonApi,
        ...
        CommonService commonService)
    {
        ...
        var parentDirectoryAbsolutePath = new AbsolutePath(parentDirectory, true, fileSystemProvider, tokenBuilder: new StringBuilder(), formattedBuilder: new StringBuilder(), AbsolutePathNameKind.NameWithExtension);
    ...
    {
        var dropdownKey = editContext.TextEditorService.DropdownKey;
        var tabWidth = editContext.TextEditorService.Options_GetOptions().TabWidth;
        ...
        TextEditorComponentData componentData)
    {
        ...
        ShowDropdown(
            ...
            leftOffset: null,
            topOffset: null,
            typeof(Clair.TextEditor.RazorLib.TextEditors.Displays.Internals.ContextMenu),
            new Dictionary<string, object?>
            {
                {
                    nameof(Clair.TextEditor.RazorLib.TextEditors.Displays.Internals.ContextMenu.ComponentDataKey),
        ...
        TextEditorComponentData componentData)
    {
        ...
        ShowDropdown(
            ...
            leftOffset: null,
            topOffset: null,
            typeof(Clair.TextEditor.RazorLib.TextEditors.Displays.Internals.AutocompleteMenu),
            new Dictionary<string, object?>
            {
                {
                    nameof(Clair.TextEditor.RazorLib.TextEditors.Displays.Internals.AutocompleteMenu.ComponentDataKey),
                    componentData.ComponentDataKey
                },
            });
    }
    ...
    public static async ValueTask ShowFindOverlay(
        ...
        TextEditorModel modelModifier,
        TextEditorViewModel viewModel,
        ClairCommonJavaScriptInteropApi commonJavaScriptInteropApi)
    {
    ...
    public static Task OnWheel(Clair.Common.RazorLib.Tooltips.Models.ITooltipModel tooltipModel, WheelEventArgs wheelEventArgs)
    {
        ...
        if (tooltipModel.ItemUntyped is not ValueTuple<TextEditorService, int, int> tuple)
            return Task.CompletedTask;
        ...
        tuple.Item1.WorkerArbitrary.PostUnique(editContext =>
        {
            ...
            tuple.Item1.WorkerUi.Enqueue(
                ...
                Clair.TextEditor.RazorLib.BackgroundTasks.Models.TextEditorWorkUiKind.OnWheel);
