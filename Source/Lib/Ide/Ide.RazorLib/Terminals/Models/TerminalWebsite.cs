...
using Clair.Ide.RazorLib.Exceptions;
...
/// </summary>
public sealed class TerminalWebsite : ITerminal, IBackgroundTaskGroup
{
        ...
        TextEditorService textEditorService)
    {
        ...
        TextEditorViewModelKey = textEditorService.NewViewModelKey();
    ...
    */
        ...
        CancellationToken cancellationToken)
    {
        ...
        throw new ClairIdeException($"The method '{nameof(DotNetWebsiteCliAsync)}' should return on each branch of the switch statement.");
    }
    ...
    public const string RESERVED_TARGET_FILENAME_PREFIX = "Clair_";
    ...
    public int TextEditorViewModelKey { get; init; }
