...
public partial class CommonUiIsland : ComponentBase, IDisposable
{
    ...
    private readonly string _measureLineHeightElementId = "ci_measure-lineHeight";
    ...
    private string _measureCharacterWidthAndLineHeightElementId = "ci_te_measure-charWidth-lineHeight";
        ...
        if (firstRender)
        {
            if (DotNetService.CommonService.ClairHostingInformation.ClairHostingKind == ClairHostingKind.Photino)
            {
                ...
                await DotNetService.CommonService.JsRuntimeCommonApi.JsRuntime.InvokeVoidAsync(
                    "clairConfig.appWideKeyboardEventsInitialize",
                    _dotNetHelper);
            }
        }
    ...
    private async Task HandleMeasureCommon()
    {
        ...
        var lineHeight = await DotNetService.CommonService.JsRuntimeCommonApi.JsRuntime.InvokeAsync<int>(
            "clairCommon.getLineHeightInPixelsById",
    ...
    private void MeasureTextEditor_GetReady()
    {
        ...
        DotNetService.CommonService.UiStringBuilder.Append("ci_te_text-editor-css-wrapper ");
        ...
        var fontSizeInPixels = options.CommonOptions.FontSizeInPixels;
        DotNetService.CommonService.UiStringBuilder.Clear();
                ...
                if (_index < textEditorGroup.ViewModelKeyList.Count)
                {
                    ...
                    DotNetService.TextEditorService.WorkerArbitrary.PostUnique(async editContext =>
                    {
                        ...
                        DotNetService.TextEditorService.Group_SetActiveViewModel(
                            Clair.TextEditor.RazorLib.TextEditorService.EditorTextEditorGroupKey,
                            viewModelKey);
                    });
                }
            }
    ...
    {
        /*DotNetService.CommonService.SetWidget(new Clair.Common.RazorLib.Widgets.Models.WidgetModel(
            typeof(Clair.Ide.RazorLib.CommandBars.Displays.CommandBarDisplay),
    ...
    public async Task CodeSearchOnKeyDown()
    {
        DotNetService.CommonService.Dialog_ReduceRegisterAction(DotNetService.IdeService.CodeSearchDialog ??= new DialogViewModel(
            ...
            "Code Search",
            typeof(Clair.Ide.RazorLib.CodeSearches.Displays.CodeSearchDisplay),
            null,
            null,
            true,
            null));
