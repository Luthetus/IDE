...
public sealed partial class DotNetSolutionFormDisplay : ComponentBase, IDisposable
{
    [Inject]
    ...
    private async Task StartNewDotNetSolutionCommandOnClick()
    {
        ...
        if (DotNetService.IdeService.CommonService.ClairHostingInformation.ClairHostingKind != ClairHostingKind.Photino)
        {
                ...
                new Key<TerminalCommandRequest>(NewDotNetSolutionTerminalCommandRequestKey.Guid))
            {
                ContinueWithFunc = parsedCommand =>
                {
                    ...
                    var parentDirectoryAbsolutePath = new AbsolutePath(
                        localParentDirectoryName,
                        true,
                        DotNetService.IdeService.CommonService.FileSystemProvider,
                    ...
                    var solutionAbsolutePathString =
                        ...
                        localSolutionName +
                        DotNetService.IdeService.CommonService.FileSystemProvider.DirectorySeparatorChar +
                        localSolutionName +
                        '.' +
        ...
        string localParentDirectoryName)
    {
        var directoryContainingSolution =
            DotNetService.IdeService.CommonService.FileSystemProvider.JoinPaths(localParentDirectoryName, localSolutionName) +
            DotNetService.IdeService.CommonService.FileSystemProvider.DirectorySeparatorChar;
        ...
        var solutionAbsolutePathString = DotNetService.IdeService.CommonService.FileSystemProvider.JoinPaths(
