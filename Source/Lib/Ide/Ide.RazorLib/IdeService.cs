...
public sealed partial class IdeService : IBackgroundTaskGroup
{
    ...
    public void Editor_ShowInputFile()
    {
        Enqueue(new IdeWorkArgs
        {
            ...
            OnAfterSubmitFunc = absolutePath =>
            {
                ...
                CommonService.FileSystemProvider.DeletionPermittedRegister(new(absolutePath.Value, isDirectory: true), tokenBuilder: new StringBuilder(), formattedBuilder: new StringBuilder());
    ...
    private async ValueTask Do_SetFolderExplorerTreeView(AbsolutePath folderAbsolutePath)
    {
        ...
        CommonService.TreeView_DisposeContainerAction(FolderExplorerState.TreeViewContentStateKey, shouldFireStateChangedEvent: false);
        ...
        await rootNode.LoadChildListAsync(container);
        ...
        List<InputFilePattern> inputFilePatternsList)
    {
        ...
        var inputFileDialog = new DialogViewModel(
            ...
            "Input File",
            typeof(Clair.Ide.RazorLib.InputFiles.Displays.InputFileDisplay),
            null,
            "ci_ide_dialog-padding-0",
            true,
            null);
