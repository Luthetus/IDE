...
public sealed partial class TextEditorViewModelSlimDisplay : ComponentBase, IDisposable
{
    ...
    private int _linkedViewModelKey = 0;
    ...
    private void CssOnInitialized()
    {
        ...
        // ContentElementId = $"ci_te_text-editor-content_{_textEditorHtmlElementId}";
        
        VERTICAL_ScrollbarElementId = $"ci_te_{VERTICAL_scrollbarGuid}";
        VERTICAL_ScrollbarSliderElementId = $"ci_te_{VERTICAL_scrollbarGuid}-slider";
        
        HORIZONTAL_ScrollbarElementId = $"ci_te_{HORIZONTAL_scrollbarGuid}";
        HORIZONTAL_ScrollbarSliderElementId = $"ci_te_{HORIZONTAL_scrollbarGuid}-slider";
        
        CONNECTOR_ScrollbarElementId = $"ci_te_{Guid.NewGuid()}";
        ...
        _componentData.CursorCssClassBlinkAnimationOn = $"ci_te_text-editor-cursor ci_te_blink {TextCursorKindFacts.BeamCssClassString}";
        _componentData.CursorCssClassBlinkAnimationOff = $"ci_te_text-editor-cursor {TextCursorKindFacts.BeamCssClassString}";
    }
    ...
    public void HandleTextEditorViewModelKeyChange()
    {
        ...
        TextEditorService.WorkerArbitrary.PostUnique(editContext =>
        {
            ...
            var linkedViewModelKey = _linkedViewModel?.PersistentState.ViewModelKey ?? 0;
