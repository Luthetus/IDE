...
namespace Clair.TextEditor.RazorLib.Events.Models;
...
public static class EventUtils
{
    ...
    public static Task<(int LineIndex, int ColumnIndex, double PositionX, double PositionY)> CalculateLineAndColumnIndex(
