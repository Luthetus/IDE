...
public sealed partial class TestExplorerDetailsDisplay : ComponentBase, IDisposable
{
    [Inject]
    ...
    public const int DetailsTextEditorViewModelKey = 3;
    ...
    private async Task UpdateContent()
    {
        ...
        if (newContent != _previousContent)
        {
            ...
            IdeService.TextEditorService.WorkerArbitrary.PostUnique(editContext =>
            {
                ...
                var compilerServiceResource = modelModifier.PersistentState.CompilerService.GetResourceByResourceUri(
