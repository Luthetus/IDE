...
// !!!
//
// This file is a copy and paste of System.IO.StreamReader.
//     https://github.com/dotnet/runtime/blob/1d1bf92fcf43aa6981804dc53c5174445069c9e4/src/libraries/System.Private.CoreLib/src/System/IO/StreamReader.cs#L1412
// Modifications to the pasted content were made to fit my needs.
// Mostly I needed to pool the private buffers.
//
// !!!
// !!!
// !!!
...
public class StreamReaderPooledBuffer : TextReader
{
    ...
    public const int DefaultBufferSize = 1024;  // Byte buffer size
    ...
    public readonly byte[] _byteBuffer = null!; // only null in NullStreamReader where this is never used
    public char[] _charBuffer = null!; // only null in NullStreamReader where this is never used
    ...
    public StreamReaderPooledBuffer(
        Stream stream,
        Encoding encoding,
        byte[] byteBuffer,
        char[] charBuffer)
    {
        ...
        int preambleLength = _encoding.Preamble.Length;
        _checkPreamble = preambleLength > 0 && preambleLength <= DefaultBufferSize;
    ...
    public void DiscardBufferedData(Stream stream)
    {
        CheckAsyncTaskInProgress();
        ...
        /*
         // The CTOR code is here for reference while I change this
    ...
    public override int Read(char[] buffer, int index, int count)
    {
        ...
        {
            throw new NotImplementedException("throw new ArgumentException(SR.Argument_InvalidOffLen);");
        }
