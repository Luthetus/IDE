...
namespace Clair.Common.RazorLib.Dropdowns.Displays;

public sealed partial class DropdownDisplay : ComponentBase, IDisposable
{
    [Inject]
    ...
    {
        _htmlElementId = $"ci_dropdown_{_htmlElementIdSalt}";
...
/*#if DEBUG
        ...
        else if (CommonService.ClairHostingInformation.ClairPurposeKind == ClairPurposeKind.Ide && _hasPendingEvent)
        {        
