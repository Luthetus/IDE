...
public sealed record TextEditorState
{
    ...
    public readonly Dictionary<int, TextEditorViewModel> _viewModelMap = new();
    ...
    public (TextEditorModel? TextEditorModel, TextEditorViewModel? TextEditorViewModel)
        GetModelAndViewModelOrDefault(ResourceUri resourceUri, int viewModelKey)
    {
    ...
    public TextEditorViewModel? ViewModelGetOrDefault(int viewModelKey)
    {
    ...
    /// Returns a shallow copy
    /// </summary>
    public Dictionary<int, TextEditorViewModel> ViewModelGetViewModels()
    {
        try
        {
            return new Dictionary<int, TextEditorViewModel>(_viewModelMap);
        }
        catch (Exception e)
        {
            Console.WriteLine(e);
