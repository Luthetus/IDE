...
public sealed partial class TextEditorDefaultHeaderDisplay : ComponentBase, ITextEditorDependentComponent
{
    [Inject]
    ...
    public string _reloadButtonHtmlElementId = "ci_te_text-editor-header-reload-button";
