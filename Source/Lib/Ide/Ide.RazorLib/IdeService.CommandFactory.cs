...
public partial class IdeService
{
        ...
        var openContextSwitchDialogCommand = new CommonCommand(
            ...
            async commandArgs =>
            {
                var elementDimensions = await CommonService.JsRuntimeCommonApi
                    .MeasureElementById("ci_header-button-file")
                    .ConfigureAwait(false);
                ...
                {
                    CommonService.GetContextSwitchState().FocusInitiallyContextSwitchGroupKey = ClairTextEditorInitializer.ContextSwitchGroupKey;
                }
                else
                {
                    CommonService.GetContextSwitchState().FocusInitiallyContextSwitchGroupKey = ClairCommonInitializer.ContextSwitchGroupKey;
                }
    ...
    {
        var absolutePath = new AbsolutePath(resourceUriValue, isDirectory: false, CommonService.FileSystemProvider, tokenBuilder: new StringBuilder(), formattedBuilder: new StringBuilder(), AbsolutePathNameKind.NameWithExtension);
