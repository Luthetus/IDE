...
namespace Clair.Common.RazorLib.Resizes.Displays;

public sealed partial class ResizableDisplay : ComponentBase, IDisposable
{
    [Inject]
    ...
    private string GetEastResizeHandleStyleCss()
    {
        ...
        return _eastResizeHandleDimensions.GetStyleString(CommonService.UiStringBuilder);
    }
    ...
    private string GetSouthResizeHandleStyleCss()
    {
        ...
        return _southResizeHandleDimensions.GetStyleString(CommonService.UiStringBuilder);
    }
    ...
    private string GetWestResizeHandleStyleCss()
    {
        ...
        return _westResizeHandleDimensions.GetStyleString(CommonService.UiStringBuilder);
    }
    ...
    private string GetSouthEastResizeHandleStyleCss()
    {
        ...
        return _southEastResizeHandleDimensions.GetStyleString(CommonService.UiStringBuilder);
    }
    ...
    private string GetSouthWestResizeHandleStyleCss()
    {
        ...
        return _southWestResizeHandleDimensions.GetStyleString(CommonService.UiStringBuilder);
    }
    ...
    private string GetNorthWestResizeHandleStyleCss()
    {
        ...
        return _northWestResizeHandleDimensions.GetStyleString(CommonService.UiStringBuilder);
    }
